...
{
    uint32_t result = rand_u32(seed, 0, RAND32MAX);
    ...
    result = rand_u32(seed, RAND32MAX, RAND32MAX);
...
{
    uint64_t result = rand_u64(seed, 0, RAND64MAX);
    ...
    result = rand_u64(seed, RAND64MAX, RAND64MAX);
...
{
    uint32_t result = rand_u32(seed, min, max);
...
{
    uint64_t result = rand_u64(seed, min, max);
...
void rngflt_t(void)
{
    long double result = rand_f32(seed);
    ...
    long double *results = rand_2f32(seed);
